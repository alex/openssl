...
static const ERR_STRING_DATA CT_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SIGN, 0), "SCT_sign"},
    {0, NULL}
};
...
static const ERR_STRING_DATA CT_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_CT, 0, CT_R_SCT_ENTRY_TYPE_MISMATCH),
    "sct entry type mismatch"},
    {ERR_PACK(ERR_LIB_CT, 0, CT_R_SCT_FUTURE_TIMESTAMP),
    "sct future timestamp"},
    {ERR_PACK(ERR_LIB_CT, 0, CT_R_SCT_INVALID), "sct invalid"},
    {ERR_PACK(ERR_LIB_CT, 0, CT_R_SCT_INVALID_KEY), "sct invalid key"},
    {ERR_PACK(ERR_LIB_CT, 0, CT_R_SCT_INVALID_SIGNATURE),
    "sct invalid signature"},
    {ERR_PACK(ERR_LIB_CT, 0, CT_R_SCT_ISSUER_PROVIDED), "sct issuer provided"},
    {ERR_PACK(ERR_LIB_CT, 0, CT_R_SCT_ISSUER_REQUIRED), "sct issuer required"},
